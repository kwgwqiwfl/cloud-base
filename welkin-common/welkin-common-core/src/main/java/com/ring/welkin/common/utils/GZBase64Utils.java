...
public class GZBase64Utils {
    ...
    public static void main(String[] args) throws Exception {
        String original = "{\n" +
            ...
            "                                    \"outputDatasetDir\": \"cloud/qaoutput\",\n" +
            ...
            "                                \"description\": \"cloud/qaoutput/qa_sink_RuleCustomEL_20181219023545971\",\n" +
        ...
        String uncompressed = uncompressString("H4sIAAAAAAAAAIuuVkpJLEksTi0pVrKKVsotzSnJjE/NSSwuyUwuTk0sSs5QitVRSstMzUlRslJKBkoUK9XGAgApLGXmNgAAAA==");
