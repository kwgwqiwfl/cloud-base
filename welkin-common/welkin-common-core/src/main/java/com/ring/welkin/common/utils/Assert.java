...
public abstract class Assert {
    ...
    /**
     * Assert a boolean expression, throwing an {@code IllegalArgumentException} if
     * the expression evaluates to {@code true}.
     *
     * <pre class="code">
     ...
     *
     * <pre class="code">
     * Assert.isFalse(i &lt; 0, () -&gt; "The value '" + i + "' must be less than zero");
     * </pre>
     *
     * @param expression      a boolean expression
     * @param messageSupplier a supplier for the exception message to use if the
    ...
    /**
     * @deprecated as of 4.3.7, in favor of {@link #isFalse(boolean, String)}
     */
    @Deprecated
     ...
     * @since 5.0
     */
    public static void isNotEmpty(String text, Supplier<String> messageSupplier) {
        if (!StringUtils.isNotEmpty(text)) {
            throw new IllegalArgumentException(nullSafeGet(messageSupplier));
        }
    }
    ...
    /**
     * @deprecated as of 4.3.7, in favor of {@link #isNotEmpty(String, String)}
     */
    @Deprecated
    ...
    /**
     * Assert that the given String is empty; that is, it must be {@code null} or
     * the empty String.
     *
     * <pre class="code">
     ...
     * @param text    the String to check
     * @param message the exception message to use if the assertion fails
     * @throws IllegalArgumentException if the text is not empty
     ...
     *
     * <pre class="code">
     * Assert.isEmpty(name, () -&gt; "Name for account '" + account.getId() + "' must be empty");
     * </pre>
     *
     * @param text            the String to check
     * @param messageSupplier a supplier for the exception message to use if the
     ...
     * @since 5.0
     */
    public static void isEmpty(String text, Supplier<String> messageSupplier) {
        if (StringUtils.isNotEmpty(text)) {
            throw new IllegalArgumentException(nullSafeGet(messageSupplier));
        }
    }
    ...
    /**
     * @deprecated as of 4.3.7, in favor of {@link #isEmpty(String, String)}
     */
    @Deprecated
    public static void isEmpty(String text) {
        isEmpty(text, "[Assertion failed] - this String argument must have no length; it must be null or empty");
    }
    ...
    /**
     * @deprecated as of 4.3.7, in favor of {@link #isNotBlank(String, String)}
     */
    @Deprecated
    ...
    /**
     * Assert that the given String contains valid text content; that is, it must be
     * {@code null} or must not contain more than one non-whitespace character.
     *
     * <pre class="code">
     ...
     * @param text    the String to check
     * @param message the exception message to use if the assertion fails
     * @throws IllegalArgumentException if the text contain valid text content
     ...
     *
     * <pre class="code">
     * Assert.isBlank(name, () -&gt; "Name for account '" + account.getId() + "' must be blank");
     * </pre>
     *
     * @param text            the String to check
     * @param messageSupplier a supplier for the exception message to use if the
    ...
    /**
     * @deprecated as of 4.3.7, in favor of {@link #isBlank(String, String)}
     */
    @Deprecated
    public static void isBlank(String text) {
        isBlank(text, "[Assertion failed] - this String argument must have text; it must be null, empty, or blank");
    }
    ...
    /**
     * Assert that an array contains elements; that is, it must be {@code null} or
     * empty.
     *
     * <pre class="code">
     * Assert.empty(array, "The array must be empty");
     * </pre>
     *
     * @param array   the array to check
     * @param message the exception message to use if the assertion fails
     * @throws IllegalArgumentException if the object array is not {@code null} and
     *                                  contains elements
     */
     ...
     *
     * <pre class="code">
     * Assert.empty(array, () -&gt; "The " + arrayType + " array must be empty");
     * </pre>
     *
     * @param array           the array to check
     * @param messageSupplier a supplier for the exception message to use if the
     ...
     * @since 5.0
     */
    public static void empty(Object[] array, Supplier<String> messageSupplier) {
        if (array != null && array.length >= 0) {
            throw new IllegalArgumentException(nullSafeGet(messageSupplier));
        }
    }
    ...
    /**
     * @deprecated as of 4.3.7, in favor of {@link #empty(Object[], String)}
     */
    @Deprecated
    public static void empty(Object[] array) {
        empty(array, "[Assertion failed] - this array must be empty: it must contain no element");
    }
    ...
    /**
     * Assert that a collection contains elements; that is, it must be {@code null}
     * or must contain no element.
     *
     * <pre class="code">
     * Assert.empty(collection, "Collection must be empty");
     * </pre>
     *
     * @param collection the collection to check
     * @param message    the exception message to use if the assertion fails
     * @throws IllegalArgumentException if the collection is not {@code null} and
     *                                  contains elements
     */
     ...
     *
     * <pre class="code">
     * Assert.empty(collection, () -&gt; "The " + collectionType + " collection must be empty");
     * </pre>
     *
     * @param collection      the collection to check
     * @param messageSupplier a supplier for the exception message to use if the
     ...
     * @since 5.0
     */
    public static void empty(Collection<?> collection, Supplier<String> messageSupplier) {
        if (CollectionUtils.isNotEmpty(collection)) {
            throw new IllegalArgumentException(nullSafeGet(messageSupplier));
        }
    }
    ...
    /**
     * @deprecated as of 4.3.7, in favor of {@link #empty(Collection, String)}
     */
    @Deprecated
    public static void empty(Collection<?> collection) {
        empty(collection, "[Assertion failed] - this collection must be empty: it must contain no element");
    }
     ...
     * @param message the exception message to use if the assertion fails
     * @throws IllegalArgumentException if the map is {@code null} or contains no
     *                                  entries
     */
    ...
    /**
     * Assert that a Map contains entries; that is, it must be {@code null} or
     * contain no entry.
     *
     * <pre class="code">
     * Assert.empty(map, "Map must be empty");
     * </pre>
     *
     * @param map     the map to check
     * @param message the exception message to use if the assertion fails
     * @throws IllegalArgumentException if the map is not {@code null} and contains
     *                                  entries
     */
     ...
     *
     * <pre class="code">
     * Assert.empty(map, () -&gt; "The " + mapType + " map be empty");
     * </pre>
     *
     * @param map             the map to check
     * @param messageSupplier a supplier for the exception message to use if the
     ...
     * @since 5.0
     */
    public static void empty(Map<?, ?> map, Supplier<String> messageSupplier) {
        if (map != null && !map.isEmpty()) {
            throw new IllegalArgumentException(nullSafeGet(messageSupplier));
        }
    }
    ...
    /**
     * @deprecated as of 4.3.7, in favor of {@link #empty(Map, String)}
     */
    @Deprecated
    public static void empty(Map<?, ?> map) {
        empty(map, "[Assertion failed] - this map must be empty; it must null or contain no entry");
    }
     ...
     * @param messageSupplier a supplier for the exception message to use if the
     *                        assertion fails. See
     *                        {@link #isInstanceOf(Class, Object, String)} for
     *                        details.
     * @throws IllegalArgumentException if the object is not an instance of type
     * @since 5.0
     */
     ...
     *                  context. If it is empty or ends in ":" or ";" or "," or ".",
     *                  a full exception message will be appended. If it ends in a
     *                  space, the name of the offending sub type will be appended.
     *                  In any other case, a ":" with a space and the name of the
     ...
     * @param messageSupplier a supplier for the exception message to use if the
     *                        assertion fails. See
     *                        {@link #isAssignable(Class, Class, String)} for
     *                        details.
     * @throws IllegalArgumentException if the classes are not assignable
     * @since 5.0
     */
