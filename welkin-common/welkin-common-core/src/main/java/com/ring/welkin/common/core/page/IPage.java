...
public class IPage<T> extends IPageable {
    ...
    protected IPage(IPageable pageable) {
        super(pageable.isPageable(), pageable.getPageNum(), pageable.getPageSize(), pageable.getOrderByClause());
    }
    ...
    protected IPage(IPageable pageable, long totalCount) {
        this(pageable.isPageable(), pageable.getPageNum(), pageable.getPageSize(), totalCount, null, null);
    }

    public static <T> IPage<T> of(IPageable pageable, int totalCount) {
        return new IPage<T>(pageable, totalCount);
    }
     ...
     * @param orderByClause 排序
     */
    protected IPage(boolean pageable, int pageNum, int pageSize, long totalCount, List<T> list, String orderByClause) {
        super(pageable, pageNum, pageSize, orderByClause);
    ...
    public static <T> IPage<T> of(boolean pageable, int pageNum, int pageSize, long totalCount, List<T> list, String orderByClause) {
     ...
     * @param list       当前页数据集合
     */
    protected IPage(boolean pageable, int pageNum, int pageSize, long totalCount, List<T> list) {
        this(pageable, pageNum, pageSize, totalCount, list, null);
    }

    public static <T> IPage<T> of(boolean pageable, int pageNum, int pageSize, long totalCount, List<T> list) {
     ...
     * @param orderByClause 排序
     */
    public static <T> IPage<T> of(int pageNum, int pageSize, long totalCount, List<T> list, String orderByClause) {
     ...
     * @param list       当前页数据集合
     */
    public static <T> IPage<T> of(int pageNum, int pageSize, long totalCount, List<T> list) {
     ...
     * @param orderByClause 排序
     */
    public static <T> IPage<T> of(int pageNum, int pageSize, long totalCount, String orderByClause) {
     ...
     * @param totalCount 数据总条数
     */
    public static <T> IPage<T> of(int pageNum, int pageSize, long totalCount) {
     ...
     * @param totalCount 数据总条数
     */
    public static <T> IPage<T> of(boolean pageable, int pageNum, int pageSize, long totalCount) {
     ...
     * @param list       当前页数据
     */
    public static <T> IPage<T> of(IPageable page, long totalCount, List<T> list) {
    ...
    public boolean isEmpty() {
        return ICollections.hasNoElements(this.list);
    }
