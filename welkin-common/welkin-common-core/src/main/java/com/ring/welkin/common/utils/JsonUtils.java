...
public class JsonUtils {
    private static final JsonMapper mapper = buildJsonMapper(false);

    private JsonUtils() {
    }

    public static JsonMapper buildJsonMapper(boolean pretty) {
        ...
        builder.configure(JsonGenerator.Feature.AUTO_CLOSE_TARGET, false);
        builder.configure(JsonParser.Feature.ALLOW_COMMENTS, true);
