...
public class JaxbUtils {
     ...
     * @param t                            java对象
     * @param clazz                        java类
     * @param format                       是否格式化xml流，默认false
     * @param fragment                     是否省略头信息，true-是，false-否
     * @param encoding                     xml编码
     * @param schema_location              The name of the property used to specify the
     *                                     xsi:schemaLocation attribute value to place in the marshalled
     *                                     XML output.
     * @param no_namespace_schema_location The name of the property used to specify the
     ...
     * @param t        java对象
     * @param clazz    java类
     * @param format   是否格式化xml文档，true-是，false-否
     * @param fragment 是否省略头信息，true-是，false-否
     * @return 返回转化xml字符串
     * @throws JAXBException
     */
