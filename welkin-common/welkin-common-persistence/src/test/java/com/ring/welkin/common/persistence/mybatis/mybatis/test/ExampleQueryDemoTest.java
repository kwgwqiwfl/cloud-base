package com.ring.welkin.common.persistence.mybatis.mybatis.test;

import com.ring.welkin.common.core.page.IPage;
import com.ring.welkin.common.persistence.mybatis.mybatis.entity.TUser;
import com.ring.welkin.common.persistence.mybatis.mybatis.service.TUserService;
...
public class ExampleQueryDemoTest extends AbstractMapperTest {
    ...
    public void selectDemo() {
        ExampleQuery query = ExampleQuery//
                ...
                .andEqualToIfNotNull("gender", 1)// gender = 1
    ...
    public void updateDemo() {
        ...
        // 3、执行更新
        // 全量字段更新
        int updateByExample = tUserService.updateByQuery(record, query);
        System.out.println(updateByExample);

        // 部分字段更新
        int updateByExampleSelective = tUserService.updateByQuerySelective(record, query);
