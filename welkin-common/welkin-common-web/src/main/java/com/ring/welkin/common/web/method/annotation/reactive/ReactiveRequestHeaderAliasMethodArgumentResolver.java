...
public class ReactiveRequestHeaderAliasMethodArgumentResolver
	extends AbstractReactiveAliasNamedValueSyncArgumentResolver {

	public ReactiveRequestHeaderAliasMethodArgumentResolver(@Nullable ConfigurableBeanFactory factory,
