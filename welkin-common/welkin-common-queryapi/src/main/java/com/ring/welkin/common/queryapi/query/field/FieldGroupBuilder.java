...
public interface FieldGroupBuilder<B extends FieldGroupBuilder<B>> extends FieldBuilder<B> {
     ...
     * @return this builder
     */
    B fields(Collection<Field> fields);
     ...
     * @return this builder
     */
    B removeFields(Collection<Field> fields);
	 ...
	 * @return this builder
	 */
	B group(FieldGroup group, boolean requirement);
	 ...
	 * @return this builder
	 */
	B andGroup(FieldGroup group, boolean requirement);
	 ...
	 * @return this builder
	 */
	B orGroup(FieldGroup group, boolean requirement);
     ...
     * @return this builder
     */
    B removeGroups(Collection<FieldGroup> groups);
