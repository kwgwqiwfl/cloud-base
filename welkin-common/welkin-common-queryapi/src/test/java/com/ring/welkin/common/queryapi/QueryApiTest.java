...
import com.ring.welkin.common.queryapi.query.aggregate.AggQuery;
import com.ring.welkin.common.queryapi.query.aggregate.AggType;
import com.ring.welkin.common.queryapi.query.field.FieldGroup;
import com.ring.welkin.common.queryapi.query.record.RecordQuery;
import com.ring.welkin.common.queryapi.sql.AggQuerySql;
import com.ring.welkin.common.queryapi.sql.RecordQuerySql;
    ...
    public void testQuery() {
        try {
            RecordQuery query = RecordQuery.builder()//
                    ...
                    .andGroup(FieldGroup.builder()//
                            .andEqualTo("name", "1")//
                            .orNotEqualToIfNotNull("name", "2"))//
    ...
    public void testQuery1() {
        try {
            RecordQuery query = RecordQuery.builder()//
                    ...
                    .orderByDesc("age");
            RecordQuerySql sql = RecordQuerySql.builder(query.table("t_user"));
            System.out.println(sql.getExecuteSql());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
